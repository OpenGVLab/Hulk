...
from core.config import Config_Hulk
...
def main():
    ...
    C_train = Config_Hulk(args.config, spec_ginfo_index=args.spec_ginfo_index)
    ...
    for test_spec_ginfo_index in range(num_test_tasks):
        C_test = Config_Hulk(args.test_config, spec_ginfo_index=test_spec_ginfo_index)
